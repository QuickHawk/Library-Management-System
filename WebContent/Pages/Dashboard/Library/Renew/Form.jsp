<div class="container">
	...
	<form>
		<div class="form-group">
			<input id="book" type="text" class="form-control" placeholder="Book ID">
		</div>
		<div class="form-group">
			<input id="patron" type="text" class="form-control" placeholder="Patron ID">
		</div>
		<div class="form-group">
			<button class="btn btn-primary" type="button" onclick="irr('renew')">
